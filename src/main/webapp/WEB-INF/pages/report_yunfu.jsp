...
<script type="text/javascript">
    ...
    function getData(num) {
        ...
        var jqXHR = $.ajax({
            async: false,
            url: 'GetReportDataServlet_Yunfu',
            datatype: 'json',
            type: "post",
            data: {
                'currentPage': num,
                ...
                if (data != null) {
                    ...
                    for (var i = 0; i < dataArray.length; i++) {
                        $("#datatable tbody").append(
                                ...
                                '<td>' + dataArray[i].MH2_A + '</td>' +
                                '<td>' + dataArray[i].AT_A + '</td>' +
                                '<td>' + dataArray[i].Plinest_A + '</td>' +
                                '<td>' + dataArray[i].Llinest_A + '</td>' +
                                '<td>' + dataArray[i].PRISE_A + '</td>' +

                                '<td>' + dataArray[i].ALLMH2_A + '</td>' +
                                '<td>' + dataArray[i].Pend_A + '</td>' +
                                '<td>' + dataArray[i].P0_A + '</td>' +

                                '<td>' + dataArray[i].Ptarget_A + '</td>' +
                                '<td>' + dataArray[i].MH2_B + '</td>' +

                                '<td>' + dataArray[i].AT_B + '</td>' +
                                '<td>' + dataArray[i].Plinest_B + '</td>' +
                                '<td>' + dataArray[i].Llinest_B + '</td>' +
                                '<td>' + dataArray[i].PRISE_B + '</td>' +
                                '<td>' + dataArray[i].ALLMH2_B + '</td>' +
                                '<td>' + dataArray[i].Pend_B + '</td>' +
                                '<td>' + dataArray[i].P0_B + '</td>' +
                                '<td>' + dataArray[i].Ptarget_B + '</td>' +
                                '<td>' + dataArray[i].Pout_H2_1_1 + '</td>' +
                                '<td>' + dataArray[i].Pin_H2_1_1 + '</td>' +
                                '<td>' + dataArray[i].Tout_H2_1_1 + '</td>' +
                                '<td>' + dataArray[i].Pout_H2_2_1 + '</td>' +
                                '<td>' + dataArray[i].Pin_H2_2_1 + '</td>' +
                                '<td>' + dataArray[i].Tout_H2_2_1 + '</td>' +
                                '<td>' + dataArray[i].P_H_tank_2_1 + '</td>' +
                                '<td>' + dataArray[i].P_M_TANK_2_1 + '</td>' +
                                '<td>' + dataArray[i].P_L_TANK_2_1 + '</td>' +
    ...
    $("#exportExcel").click(function () {
        ...
        var end_date = $("#end_date").val();
        var searchType = $("#searchType").val();
        window.open("ExportExcelServlet_Yunfu?start_date="+start_date+"&end_date="+end_date+"&searchType="+searchType);
    });
